...
!function (e, n, t) {
    ...
    function r() {
        ...
        for (var f in y)if (y.hasOwnProperty(f)) {
            ...
            for (r = o(n.fn, "function") ? n.fn() : n.fn, s = 0; s < e.length; s++)i = e[s], a = i.split("."), 1 === a.length ? Modernizr[a[0]] = r : (!Modernizr[a[0]] || Modernizr[a[0]] instanceof Boolean || (Modernizr[a[0]] = new Boolean(Modernizr[a[0]])), Modernizr[a[0]][a[1]] = r), w.push((r ? "" : "no-") + a.join("-"))
        }
    }
    ...
    function p(e, n, r, s) {
        ...
        for (var u, p, m, v, h, g = ["modernizr", "tspan"]; !N.style;)u = !0, N.modElem = i(g.shift()), N.style = N.modElem.style;
        for (m = e.length, p = 0; m > p; p++)if (v = e[p], h = N.style[v], l(v, "-") && (v = d(v)), N.style[v] !== t) {
    ...
    function h(e, n, t, r, s) {
        ...
        return o(n, "string") || o(n, "undefined") ? p(a, n, r, s) : (a = (e + " " + P.join(i + " ") + i).split(" "), v(a, n, t))
    }
    ...
    var w = [], x = n.documentElement, S = "svg" === x.nodeName.toLowerCase(), _ = C._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : [];
    C._prefixes = _;
    var T = C.testStyles = f;
    ...
    var b = "Moz O ms Webkit", z = C._config.usePrefixes ? b.split(" ") : [];
    C._cssomPrefixes = z;
    ...
    var P = C._config.usePrefixes ? b.toLowerCase().split(" ") : [];
    C._domPrefixes = P, C.testAllProps = h, C.testAllProps = g, Modernizr.addTest("csstransforms", function () {
        return -1 === navigator.userAgent.indexOf("Android 2.") && g("transform", "scale(1)", !0)
    }), Modernizr.addTest("canvas", function () {
        var e = i("canvas");
        return !(!e.getContext || !e.getContext("2d"))
    }), Modernizr.addTest("svg", !!n.createElementNS && !!n.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect), r(), s(w), delete C.addTest, delete C.addAsyncTest;
